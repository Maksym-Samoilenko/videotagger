...
_V_.Tagger = _V_.Button.extend({
  ...
  buildCSSClass: function(){
    return "vjs-tagger-button " + this._super();
  },
  ...
  onClick: function(){
    if (this.player.paused()) {
      ...
      this.player.pause();
      var vplayer = this.player;
       
      console.log(this.player.id);
      Bubbles.videoJS(this.player.id, 'bubblesContainer', {momentum:{type: "content",effect: "slide",className: "bubbles2",content: "<span class='sticky'><input type='text' id='momentumtext'><button id='Momentum''>submit moment</button></span>",dimensions: ["30%","30%"],position: ["200px","240px"],config: [this.player.currentTime(),this.player.currentTime()+3]}});
      $("#Momentum").click( function(){
  ...
  dataType: 'json',
  type: 'GET',
  data: { 'moment' : '{"content": "'+$('#momentumtext').val()+'", "start": "'+(vplayer.currentTime() - 5)+'","videoid": "'+vplayer.id+'", "end": "'+(vplayer.currentTime())+'"}'}
}).done(function( data ) {
  console.log(data);
console.log(Bubbles.video(vplayer.id).bubbleObject)
